          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href="/signup"
                  className="inline-flex h-13 items-center justify-center rounded-2xl bg-gradient-to-r from-white to-slate-100 px-7 text-sm font-extrabold text-slate-950 shadow-[0_18px_45px_rgba(255,255,255,0.12)] transition hover:translate-y-[-1px] hover:shadow-[0_22px_52px_rgba(255,255,255,0.16)]"
                >
                  무료로 시작하기
                </a>
                ...
                <a
                  href="/login"
                  className="inline-flex h-13 items-center justify-center rounded-2xl border border-white/20 bg-white/5 px-7 text-sm font-semibold text-white backdrop-blur transition hover:bg-white/10"
                >
                  로그인하기
                </a>
              </div>
                ...
                {[
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      {row.value === "적정 지원" && (
                        <span className="rounded-full border border-emerald-500/30 bg-emerald-500/15 px-3 py-1 text-sm font-bold text-emerald-300">
                          적정
                        </span>
                      )}
                    </div>
